  ...
  return (
    <div className="About">
      ...
      <div className="reating_box">
        <div className="reating_about_rum reating_about">
          ...
          <div className="reating_resalte">
            <div
              className={element1 ? "reting_in_Show" : "reting_in"}
              ref={html}
            ></div>
          </div>
        </div>
        ...
        <div className="reating_about_rum reating_about2">
          ...
          <div className="reating_resalte2">
            <div
              className={element2 ? "reting_in2_Show" : "reting_in2"}
              ref={css}
            ></div>
          </div>
        </div>
        <div className="reating_about_rum reating_about3">
          ...
          <div className="reating_resalte3">
            <div
              className={element3 ? "reting_in3_Show" : "reting_in3"}
              ref={java}
            ></div>
          </div>
        </div>
        <div className=" reating_about_rum reating_about4">
          ...
          <div className="reating_resalte4">
            <div
              className={element4 ? "reting_in4_Show" : "reting_in4"}
              ref={react}
            ></div>
          </div>
        </div>
        <div className="reating_about_rum  reating_about5">
          ...
          <div className="reating_resalte5">
            <div
              className={element5 ? "reting_in5_Show" : "reting_in5"}
              ref={photoshop}
            ></div>
          </div>
        </div>
        <div className="reating_about_rum reating_about6">
          ...
          <div className="reating_resalte6">
            <div
              className={element6 ? "reting_in6_Show" : "reting_in6"}
              ref={github}
            ></div>
          </div>
        </div>
      ...
      <div className="about_reating">
        <ul>
          <li className={element7 ? "abouttext" : ""} ref={abouttext}>
            Git
          </li>
          <li className={element7 ? "abouttext2" : ""} ref={abouttext}>
            Quick learning
          </li>
          <li className={element7 ? "abouttext3" : ""} ref={abouttext}>
            RWD
          </li>
        </ul>
        <ul>
